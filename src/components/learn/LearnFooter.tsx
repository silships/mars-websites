...
export default function LearnFooter() {
  ...
  return (
    <footer className="bg-[#030303] border-t border-white/[0.05] py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          {/* Brand */}
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#ff4d00] to-[#ff7b3d] flex items-center justify-center">
            ...
            <p className="text-zinc-400 max-w-md mb-6">
              An educational experience designed to inspire curiosity about Mars 
              and humanity's journey to become a multi-planetary species.
            </p>
        ...
        <div className="pt-8 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600">
            © {new Date().getFullYear()} LearnMars. Educational content for space enthusiasts.
          </p>
